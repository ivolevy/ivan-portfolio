  ...
  const projects = [
    {
      ...
      date: "02 · 2024",
      description: "An AI-powered playlisting system built for record labels to automatically generate massive artist playlists with a simple prompt in 2 minutes, saving up to 8 hours of marketing work per week.",
      img: spotify,
